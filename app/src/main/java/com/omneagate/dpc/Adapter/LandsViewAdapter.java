 ...
 */
public class LandsViewAdapter extends RecyclerView.Adapter<LandsViewAdapter.LandsAdapterHolder> {
    private Context context;
    List<FarmerLandDetailsDto> list_lands;
    private LayoutInflater mLayoutInflater;
    FarmerRegistrationRequestDto farmerRegistrationRequest;

    public LandsViewAdapter(Context context, List<FarmerLandDetailsDto> list_lands, FarmerRegistrationRequestDto farmerRegistrationRequest) {

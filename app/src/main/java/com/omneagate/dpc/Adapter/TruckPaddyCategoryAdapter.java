 ...
 */
public class TruckPaddyCategoryAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<PaddyCategoryDto> paddy_name;

    public TruckPaddyCategoryAdapter(Context context, List<PaddyCategoryDto> paddy_name) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.adapter_truck_paddy_category, viewGroup, false);

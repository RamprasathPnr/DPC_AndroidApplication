 ...
 */
public class ProcurementSearchByFarmerCodeAdapter extends BaseAdapter {
    ...
    public ProcurementSearchByFarmerCodeAdapter(Context context, List<DPCProcurementDto> procurementList) {
...
//        holder.procurement_num.setText(getItem(position).getProcurementReceiptNo());
        ...
        holder.farmer_code.setText("" + paddy);

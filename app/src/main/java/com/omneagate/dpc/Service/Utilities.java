...
//                    BlazeUtils.getInstance().showLongToast(Application.getInstance().getApplicationContext().getResources().getString(R.string.no_connection));
    ...
    public void makeServiceCall__(Context mContext, boolean showProgress, final String URL, String hmParams, String TAG, final ServiceResponseListener listener, String url_enum, String method) {
        try {
            networkConnection = new NetworkConnection(mContext);

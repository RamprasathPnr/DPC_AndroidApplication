...
import com.omneagate.dpc.Activity.ProcurementHistory;
 ...
 */
public class DialogProcurementDateSelection extends Dialog implements View.OnClickListener {
    ...
    public DialogProcurementDateSelection(Activity _context) {
        super(_context);
        context = _context;
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.buttonNwOk:
                ProcurementHistory.IsClickedDate=false;
                SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
                ((ProcurementHistory) context).setTextDate(sdf.format(widget.getSelectedDate().getDate()));
                dismiss();
                break;

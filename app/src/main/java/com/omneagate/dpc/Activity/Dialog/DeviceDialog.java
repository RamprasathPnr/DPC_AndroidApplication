...
/**
 * This dialog will appear on the time of user clicks the Device Details menu
 */

public class DeviceDialog extends Dialog implements
    ...
    public DeviceDialog(Activity _context) {
        super(_context);
        context = _context;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_ok = (Button) findViewById(R.id.buttonNwOk);
       // setTamilText(okButton, R.string.ok);
        btn_ok.setOnClickListener(this);
        Bitmap bitmap = null;

        Log.e("device_number", "" + props.getDeviceProperties().getSerialNumber());
        Log.e("devicenumber_serial",getSerialNumber());

        //Util.messageBar(context, getSerialNumber());

...
import com.omneagate.dpc.Activity.Dialog.RestorationLocalDbDialog;
import com.omneagate.dpc.Activity.Dialog.RetrieveLocalDbDialog;
        ...
        if (mExternalStorageAvailable & mExternalStorageWriteable & getExternalAvailableSize()) {
            ...
            try {
                if (success) {
                    ...
                    fileSourceBackup = new File(mSdPath + "/backup/", DBHelper.DATABASE_NAME);

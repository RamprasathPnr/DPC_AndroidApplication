...
import com.omneagate.dpc.Model.DpcDeviceDetailsDto;
...
public class AndroidDeviceProperties {
    ...
    DpcDeviceDetailsDto androidDevice;
    //Constructor
    ...
    public DpcDeviceDetailsDto getDeviceProperties() {
        androidDevice = new DpcDeviceDetailsDto();
    ...
    private DpcDeviceDetailsDto apkDetails(DpcDeviceDetailsDto androidDevice) {
    ...
    public DpcDeviceDetailsDto getAllDeviceDetails() {
        return androidDevice;
    }
}
